...
import nothingplayer.composeapp.generated.resources.desktop_webview_description
import nothingplayer.composeapp.generated.resources.open_guide
...
actual fun PlatformWebView(
    ...
    Box(
        ...
        Column(
            ...
            Button(
                onClick = {
                    openUrl("https://www.nothingplayer.org/blogs/en/how-to-log-in-on-desktop-app")
                },
            ) {
                Text(
                    stringResource(Res.string.open_guide),
                    style = typo().labelMedium,
...
actual fun DiscordWebView(
    ...
    Box(
        ...
        Column(
            ...
            Button(
                onClick = {
                    openUrl("https://www.nothingplayer.org/blogs/en/how-to-log-in-to-Discord-on-desktop-app")
                },
            ) {
                Text(
                    stringResource(Res.string.open_guide),
