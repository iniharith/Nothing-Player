package com.nothingplayer.app.ui.screen.login
...
import com.nothingplayer.app.viewModel.LastfmLoginState
...
import nothingplayer.composeapp.generated.resources.lastfm_login_step_1
import nothingplayer.composeapp.generated.resources.lastfm_login_step_2
import nothingplayer.composeapp.generated.resources.lastfm_open_authorize_page
import nothingplayer.composeapp.generated.resources.lastfm_paste_callback_confirm
import nothingplayer.composeapp.generated.resources.lastfm_paste_callback_hint
import nothingplayer.composeapp.generated.resources.lastfm_paste_callback_title
...
/**
 * Last.fm's desktop auth flow, which is what Nothing Player uses on every platform.
 *
 * There is no WebView here on purpose — unlike the Discord and Spotify screens, this never sees the
 * user's password. Nothing Player asks Last.fm for a request token, sends the user to Last.fm's own page
