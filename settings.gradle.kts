...
dependencyResolutionManagement {
    ...
    repositories {
        ...
        // Nothing Glyph Matrix SDK (com.nothing:glyph-matrix-sdk)
        ivy {
...
// sibling `../core` outside Nothing Player: another project (FPT Play `core`) shares
...
rootProject.name = "NothingPlayer"
include(
    ":androidApp",
    ":composeApp",
    ":desktopApp",
