# Nothing Player import format v1

This is the contract between the **Nothing Player web converter** and the **Nothing Player app**.
...
The file is produced by the converter at <https://nothingplayer.org> and consumed by
