...
/**
 * Thin entry point for Nothing Player Desktop.
 *
 ...
 */
/**
 * Force the X11 WM_CLASS so the Linux taskbar/dock shows "Nothing Player" instead of
 ...
 */
private fun forceLinuxWmClass(appName: String = "NothingPlayer") {
