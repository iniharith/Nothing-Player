package com.nothingplayer.app.service.backup
...
class AutoBackupWorker(
    ...
    override suspend fun doWork(): Result = withContext(Dispatchers.IO) {
        try {
            ...
            // Save to Downloads/Nothing Player folder
    ...
    private fun saveToDownloads(backupFile: File): Boolean {
        ...
        val fileName = "nothingplayer_backup_$timestamp.zip"
        ...
        return try {
            val contentValues = ContentValues().apply {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    put(MediaStore.Downloads.RELATIVE_PATH, "Download/Nothing Player")
                }
            }
            ...
            uri?.let { outputUri ->
                ...
                Logger.i(TAG, "Backup saved to Downloads/Nothing Player/$fileName")
                true
            } ?: false
        } catch (e: Exception) {
    ...
    private fun cleanupOldBackups(maxFiles: Int) {
        try {
            ...
            val selectionArgs = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                arrayOf("Download/Nothing Player/", "nothingplayer_backup_%.zip")
            } else {
                arrayOf("nothingplayer_backup_%.zip")
            }
            ...
            context.contentResolver.query(
                ...
                while (cursor.moveToNext()) {
                    ...
                    if (name.startsWith("nothingplayer_backup_") && name.endsWith(".zip")) {
