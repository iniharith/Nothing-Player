...
/**
 * Row title with a static equalizer glyph in front of [text], used to mark
 * the currently singing lyric line.
 */
internal fun CarContext.nowPlayingTitle(text: String): CharSequence =
    SpannableString("  $text").apply {
        setSpan(
            CarIconSpan.create(
                CarIcon
                    .Builder(IconCompat.createWithResource(this@nowPlayingTitle, R.drawable.ic_car_now_playing))
                    .build(),
                CarIconSpan.ALIGN_CENTER,
            ),
            0,
