 ...
 */
@UnstableApi
internal class NothingPlayerCarAppService : CarAppService() {
    ...
    override fun onCreateSession(): Session = NothingPlayerCarSession()
}
...
internal class NothingPlayerCarSession : Session() {
    ...
    private companion object {
        private const val TAG = "NothingPlayerCarSession"
