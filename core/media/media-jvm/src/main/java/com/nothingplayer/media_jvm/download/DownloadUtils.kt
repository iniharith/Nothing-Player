package com.nothingplayer.media_jvm.download
...
fun getDownloadPath(): String = System.getProperty("user.home") + File.separator + ".nothingplayer" + File.separator + "downloads"