...
import com.maxrave.kotlinytmusicscraper.models.response.NothingPlayerChartResponse
...
import com.maxrave.kotlinytmusicscraper.models.nothingplayer.FdroidResponse
import com.maxrave.kotlinytmusicscraper.models.nothingplayer.GithubResponse
 ...
 * This library is from [z-huang/InnerTune] and I just modified it to comply with Nothing Player
 *
 * Here is the object that can create all request to YouTube Music and Spotify in Nothing Player
...
class YouTube {
     ...
     * In Nothing Player, I use this function to parsing Home, Playlist, Album data instead using [album], [playlist], [artist] function
...
//        }
    ...
    suspend fun getNothingPlayerChart() =
        runCatching {
            ytMusic.getNothingPlayerChart().body<NothingPlayerChartResponse>()
        }
