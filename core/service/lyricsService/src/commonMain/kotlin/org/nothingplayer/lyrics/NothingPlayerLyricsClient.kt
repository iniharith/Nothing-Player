package org.nothingplayer.lyrics
...
import org.nothingplayer.lyrics.am.AMArtistResource
import org.nothingplayer.lyrics.am.AMSearchResponse
...
import org.nothingplayer.lyrics.models.response.BaseResponse
import org.nothingplayer.lyrics.models.response.BetterLyricsResponse
import org.nothingplayer.lyrics.models.response.LrclibObject
import org.nothingplayer.lyrics.models.response.LyricsResponse
import org.nothingplayer.lyrics.models.response.TranslatedLyricsResponse
import org.nothingplayer.lyrics.parser.parseSyncedLyrics
import org.nothingplayer.lyrics.parser.parseUnsyncedLyrics
import kotlin.math.abs

private const val TAG = "NothingPlayerLyricsClient"

class NothingPlayerLyricsClient {
    private val algorithm = ""

    private val hmacService = Hmac("HmacSHA256", "nothingplayer-lyrics")
    private val lyricsService = NothingPlayerLyrics()
