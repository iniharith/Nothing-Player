...
import org.nothingplayer.lyrics.am.AMTokenManager
...
import org.nothingplayer.lyrics.models.request.VoteBody

class NothingPlayerLyrics {
    ...
    private fun createClient() =
        HttpClient(getEngine()) {
            ...
            install(HttpCache)
            install(CurlLogger) {
                logger = { Logger.d("NothingPlayerLyrics", it) }
            }
            install(HttpSend) {
                maxSendCount = 100
            }
            ...
            if (proxy != null) {
                engine {
                    proxy = this@NothingPlayerLyrics.proxy
                }
            }
        }
    ...
    private fun HttpRequestBuilder.buildDefaultHeaders(
        ...
        headers {
            ...
            header(HttpHeaders.UserAgent, "NothingPlayerLyrics/1.0")
