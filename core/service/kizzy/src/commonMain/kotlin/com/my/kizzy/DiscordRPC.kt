...
class DiscordRPC(
    ...
    suspend fun updateSong(
        ...
        setActivity(
            ...
            buttons =
                listOf(
                    "Listen on Nothing Player" to "https://nothingplayer.org/app/watch?v=${song.videoId}",
                    "Visit Nothing Player" to "https://github.com/iniharith/Nothing-Player",
                ),
            type = Type.LISTENING,
            since = currentTime,
    ...
    companion object {
        ...
        private const val APP_NAME: String = "Nothing Player"
