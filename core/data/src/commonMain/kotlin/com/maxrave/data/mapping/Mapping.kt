...
import org.nothingplayer.lyrics.parser.parseRichSyncLyrics
...
internal fun org.nothingplayer.lyrics.domain.Lyrics.toLyrics(): Lyrics {
...
internal fun Lyrics.toLibraryLyrics(): org.nothingplayer.lyrics.domain.Lyrics =
    org.nothingplayer.lyrics.domain.Lyrics(
        lyrics =
            org.nothingplayer.lyrics.domain.Lyrics.LyricsX(
                lines =
                    this.lines?.map {
                        org.nothingplayer.lyrics.domain.Lyrics.LyricsX.Line(
                            endTimeMs = it.endTimeMs,
                            startTimeMs = it.startTimeMs,
                            syllables = listOf(),
                            words = it.words,
...
// Nothing Player Lyrics Extension
