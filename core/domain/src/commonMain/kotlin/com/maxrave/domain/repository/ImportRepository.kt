...
/**
 * Writes a file produced by the Nothing Player web converter into the local database.
 *
 ...
 *
 * [com.maxrave.domain.utils.LocalResource.Loading] carries no payload, so it cannot say "X of Y
