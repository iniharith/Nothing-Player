...
interface LyricsCanvasRepository {
    ...
    fun getNothingPlayerLyrics(videoId: String): Flow<Resource<Lyrics>>

    fun getNothingPlayerTranslatedLyrics(
        videoId: String,
        language: String,
    ): Flow<Resource<Lyrics>>

    fun voteNothingPlayerLyrics(
        lyricsId: String,
        upvote: Boolean,
    ): Flow<Resource<String>>

    fun voteNothingPlayerTranslatedLyrics(
        translatedLyricsId: String,
        upvote: Boolean,
    ): Flow<Resource<String>>

    fun insertNothingPlayerLyrics(
        dataStoreManager: DataStoreManager,
        track: Track,
        duration: Int,
        lyrics: Lyrics,
    ...
    fun insertNothingPlayerTranslatedLyrics(
        dataStoreManager: DataStoreManager,
        track: Track,
