...
interface DataStoreManager {
    ...
    // Nothing Glyph
    val glyphEnabled: Flow<String>

    suspend fun setGlyphEnabled(enabled: Boolean)

    val aodLyricsColor: Flow<String>

    suspend fun setAodLyricsColor(color: String)

    val aodLyricsSize: Flow<Float>

    suspend fun setAodLyricsSize(size: Float)

    val aodShowAlbumArt: Flow<String>

    suspend fun setAodShowAlbumArt(show: Boolean)
    ...
    companion object Values {
        const val NOTHINGPLAYER = "nothingplayer"
